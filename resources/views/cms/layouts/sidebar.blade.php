<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">UEI Landing Page</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('enquiryList') }}" class="nav-link @if (Route::currentRouteName() == 'enquiryList') active @endif">
                        <i class="far fa-dot-circle nav-icon"></i>
                        <p>Enquiry</p>
                    </a>
                </li>
